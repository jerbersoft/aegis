...
4. If a task is selected, read that task's `TASK.md` and create or update `developer_handoff.md` in that task folder.
5. If no required task is ready, report whether the feature is complete for execution or blocked by dependencies.
